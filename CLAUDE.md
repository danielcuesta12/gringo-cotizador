...
**Resultado de la auditoría: 2 críticas · 33 altas · 69 medias · 66 bajas.** El núcleo de cada módulo está, pero **falta cerrar brechas para llegar a 1:1 real (regla [[yupipos-paridad-exacta]])**. Blockers principales: **(crítico)** Producto sin precio por persona/evento → cotizaciones catering en 0; **(crítico)** falta página Stock por ubicación; **(alto)** gating WhatsApp del KDS (carta 'pendiente' no debe entrar a cocina hasta que cajero acepta), idempotencia + IPN de Izipay, dashboard de Costeo, producción/despacho de subrecetas con stock, reportes (gastos/asistencia/ventas con exports XLSX), tabs/filtros + detalle de Pedidos admin, usuario activo/inactivo, alerta de reserva por correo. Ver el doc para el detalle por módulo con evidencia `archivo:línea`. **Siguiente: ir cerrando brechas por severidad antes de producción.**
