...
CREATE TABLE IF NOT EXISTS `cartas` (
  ...
  `qr2_enabled`  TINYINT(1) NOT NULL DEFAULT 0,
  `qr2_url`      VARCHAR(500) NOT NULL DEFAULT '',
  `qr2_src`      VARCHAR(80) NOT NULL DEFAULT '',
  `qr2_label`    VARCHAR(80) NOT NULL DEFAULT '',
  `col_bg`          VARCHAR(20) NOT NULL DEFAULT '#161412',
  `col_surface`     VARCHAR(20) NOT NULL DEFAULT '#211e1b',
  `col_text`        VARCHAR(20) NOT NULL DEFAULT '#ffffff',
  `col_muted`       VARCHAR(20) NOT NULL DEFAULT '#9a9089',
  `col_accent`      VARCHAR(20) NOT NULL DEFAULT '#FFDF00',
  `col_section`     VARCHAR(20) NOT NULL DEFAULT '#FFEFBC',
  `col_divider`     VARCHAR(20) NOT NULL DEFAULT '#4a4640',
  `col_header_bg`   VARCHAR(20) NOT NULL DEFAULT '#FFDF00',
  `col_header_text` VARCHAR(20) NOT NULL DEFAULT '#1A1A1A',
