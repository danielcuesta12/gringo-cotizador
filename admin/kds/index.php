...
<div id="ks">
  <div class="kt">
    ...
    <div class="km">
      <div class="cnt"><span style="width:8px;height:8px;border-radius:50%;background:#666;display:inline-block"></span><span id="cg" style="color:#888;font-weight:500">0</span><span style="color:#555;margin-left:4px">esperando</span></div>
