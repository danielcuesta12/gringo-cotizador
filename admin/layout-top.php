...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <?php if (can('dashboard') || can('quotes') || can('events')): ?>
    ...
    <?php if (can('quotes') || can('calendar') || can('clients') || can('requests')): ?>
    ...
    <?php if (can('products') || can('categories') || can('packages') || can('modifiers')): ?>
    ...
    <?php if (can('inv_insumos') || can('inv_stock') || can('inv_recetas') || can('inv_evento') || can('inv_compras') || can('inv_movimientos')): ?>
    ...
    <?php if (can('locations') || can('cartas_pdf') || can('qr') || can('pos_terminal') || can('pos_monitor') || can('pos_caja') || can('pos_clientes') || can('pos_metodos') || can('landing') || can('analytics')): ?>
